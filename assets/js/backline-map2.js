function initialise() {
    ...
    var myLatlng = new google.maps.LatLng(50.709986, -3.537044); // Add the coordinates
    ...
    var mapOptions = {
        ...
        var map = new google.maps.Map(document.getElementById('backline-map'), mapOptions); // Render our map within the empty div
        ...
        var marker = new google.maps.Marker({ // Set the marker
            ...
            title: 'Click to visit Backline Transport on Google Places' // Marker ALT Text
        });
